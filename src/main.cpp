...
uint256 hashGenesisBlock("0xd592e6110f92acc63899d45070221eaa5d75ec23950387d3d7595f6a61d178b2");
...
const string strMessageMagic = "NuCoin Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal nucoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NuCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcb1fe8d99e6e621ba80d6a95d896c52f7ffe66256466687137aebca36b4f7166");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Calgary Metro 27/05/2013 Gawker-led Rob Ford 'Crackstarter' hits goal of $200,000";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1369794433; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 135086;

        if (fTestNet)
        {
            block.nTime    = 1369699899;
            block.nNonce   = 995144;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xaa8aae222228ce124674c4810b73ec7aab76db383d826a2184a99d959aa70956"));
